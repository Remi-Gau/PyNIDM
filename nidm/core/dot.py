...
DOT_PROVONE_STYLE = {
    ...
    PROVONE_HASOUTPORT: {
		'label': 'hasOutPort', 'fontsize': '10.0'
	},
    PROVONE_HASSUBPROCESS: {
		'label': 'hasSubProcess', 'fontsize': '10.0'
	},
    PROVONE_INPORTTODL: {
		'label': 'inPortToDL', 'fontsize': '10.0'
	},
    PROVONE_OUTPORTTODL: {
		'label': 'outPortToDL', 'fontsize': '10.0'
	},
    PROVONE_CLTODESTP: {
		'label': 'CLtoDestP', 'fontsize': '10.0'
	},
    PROVONE_SOURCEPTOCL: {
		'label': 'sourcePToCL', 'fontsize': '10.0'
	},
    PROVONE_DLTOOUTPORT: {
		'label': 'DLToOutPort', 'fontsize': '10.0'
	},
    PROVONE_DLTOINPORT: {
		'label': 'DLToInPort', 'fontsize': '10.0'
	},
    PROVONE_DATAONLINK: {
		'label': 'dataOnLink', 'fontsize': '10.0'
	},
    PROVONE_ISPARTOF: {
...
def provone_to_dot(bundle, show_nary=True, use_labels=False,
                direction='BT',
